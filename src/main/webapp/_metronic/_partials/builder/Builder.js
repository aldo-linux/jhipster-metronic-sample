    ...
    <>
      <Notice svg="/media/svg/icons/Tools/Compass.svg">
        <p>
          ...
          The configured layout options will be saved until you change or reset them. To use the layout builder, choose the layout options
          and click the <code>Preview</code> button to preview the changes.
        </p>
      </Notice>
                  ...
                  <div className="tab-content pt-3">
                    <div className={`tab-pane ${key === 0 ? 'active' : ''}`}>
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Desktop Fixed Header:</label>
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Mobile Fixed Header:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Header Width:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Display Header Menu:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Header Menu Layout:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Header Menu Arrows:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                    ...
                    <div className={`tab-pane ${key === 1 ? 'active' : ''}`}>
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Display Subheader:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Fixed Subheader:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                          ...
                          />
                          <FormHelperText>
                            Enable fixed(sticky) subheader. Requires <code>Solid</code> subheader style.
                          </FormHelperText>
                        </div>
                      </div>
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Subheader Style:</label>
                        <div className="col-lg-9 col-xl-4">
                          <select
                            className="form-control"
                    ...
                    <div className={`tab-pane ${key === 3 ? 'active' : ''}`}>
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Default Minimize:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                      ...
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label pt-4 text-lg-right">Submenu Toggle:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch
                            onBlur={handleBlur}
                            onChange={handleChange}
                          ...
                          />
                          <FormHelperText>
                            Select submenu toggle mode (works only when <code>Fixed Mode</code> is disabled)
                          </FormHelperText>
                        </div>
                      </div>
                    </div>
                    <div className={`tab-pane ${key === 4 ? 'active' : ''}`}>
                      <div className="form-group row">
                        <label className="col-lg-3 col-form-label text-lg-right">Fixed Desktop Footer:</label>
                        <div className="col-lg-9 col-xl-4">
                          <Switch onBlur={handleBlur} onChange={handleChange} name="footer.fixed" checked={!!get(values, 'footer.fixed')} />
