    ...
    <>
      ...
      {languages.length === 1 && (
        <div className="example-code" style={{ background: '#F3F6F9' }}>
          ...
          <div className={`example-highlight ${languages[0].language}`}>
            <SyntaxHighlighter language={languages[0].language} style={highlightStyle} customStyle={customStyle}>
              {languages[0].code}
            </SyntaxHighlighter>
          </div>
        </div>
      ...
      {languages.length > 1 && (
        <div className="example-code example-code-on">
          <ul className="example-nav nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-primary" id="codeTab" role="tablist">
          ...
          <div className="tab-content">
            {languages.map((lang, index) => (
              <div style={{ background: '#F3F6F9' }} className={`tab-pane  ${tabId === index ? 'active' : ''}`} key={`divTabPane${index}`}>
                <div className={`example-highlight language-${lang.shortCode} ${lang.shortCode}`}>
                  <SyntaxHighlighter language={lang.language} style={highlightStyle} customStyle={customStyle}>
                    {lang.code}
                  </SyntaxHighlighter>
                </div>
              </div>
