        ...
        <div className="card-body pt-2">
          ...
          <div className="d-flex flex-wrap align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
              ...
              <span className="text-muted font-weight-bold font-size-sm">
                Created by: <span className="text-primary font-weight-bold">CoreAd</span>
              </span>
            </div>
            {/* end::Title */}
          ...
          <div className="d-flex flex-wrap align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
              ...
              <span className="text-muted font-weight-bold font-size-sm">
                Created by: <span className="text-primary font-weight-bold">KeenThemes</span>
              </span>
            </div>
            {/* end::Title */}
          ...
          <div className="d-flex flex-wrap align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1 pr-3">
              ...
              <span className="text-muted font-weight-bold font-size-sm">
                Created by: <span className="text-primary font-weight-bold">Invision Inc.</span>
              </span>
            </div>
            {/* end::Title */}
          ...
          <div className="d-flex flex-wrap align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
              ...
              <span className="text-muted font-size-sm font-weight-bold">
                Created by: <span className="text-primary font-weight-bold">Figma Studio</span>
              </span>
            </div>
            {/* end::Title */}
          ...
          <div className="d-flex flex-wrap align-items-center">
            ...
            <div className="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
              <div
                className="symbol-label"
                style={{
                  backgroundImage: `url('${toAbsoluteUrl('/media/stock-600x400/img-12.jpg')}')`,
                }}
              ></div>
            </div>
            {/* end::Symbol */}
