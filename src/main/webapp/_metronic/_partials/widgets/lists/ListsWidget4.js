        ...
        <div className="card-body pt-2">
          <div className="d-flex align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1">
              <a href="#" className="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1">
          ...
          <div className="d-flex align-items-center mb-10">
            ...
            <div className="d-flex flex-column flex-grow-1">
              <a href="#" className="text-dark-75 text-hover-primary font-size-sm font-weight-bold font-size-lg mb-1">
                Scoping & Estimations
              </a>
