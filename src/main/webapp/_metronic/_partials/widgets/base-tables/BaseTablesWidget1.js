              ...
              <tbody>
                  ...
                  <td className="pl-0">
                    <div className="symbol symbol-50 symbol-light mr-2 mt-2">
                      <span className="symbol-label">
                        <SVG className="h-75 align-self-end" src={toAbsoluteUrl('/media/svg/avatars/001-boy.svg')}></SVG>
                      </span>
                    </div>
                  </td>
                  <td className="pl-0">
                ...
                <tr>
                  <td className="pl-0">
                    <div className="symbol symbol-50 symbol-light mr-2 mt-2">
                      <span className="symbol-label">
                        <SVG className="h-75 align-self-end" src={toAbsoluteUrl('/media/svg/avatars/018-girl-9.svg')}></SVG>
                      </span>
                    </div>
                  </td>
                  <td className="pl-0">
                  ...
                  <td className="text-right">
                    <span className="text-muted font-weight-bold d-block font-size-sm">Paid</span>
                    <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$1,200,000</span>
                  </td>
                  <td className="text-right">
                ...
                <tr>
                  <td className="pl-0">
                    <div className="symbol symbol-50 symbol-light mr-2 mt-2">
                      <span className="symbol-label">
                        <SVG className="h-75 align-self-end" src={toAbsoluteUrl('/media/svg/avatars/047-girl-25.svg')}></SVG>
                      </span>
                    </div>
                  </td>
                  <td className="pl-0">
                  ...
                  <td className="text-right">
                    <span className="text-muted font-weight-bold d-block font-size-sm">Paid</span>
                    <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$3,400,000</span>
                  </td>
                  <td className="text-right">
                ...
                <tr>
                  <td className="pl-0">
                    <div className="symbol symbol-50 symbol-light mr-2 mt-2">
                      <span className="symbol-label">
                        <SVG className="h-75 align-self-end" src={toAbsoluteUrl('/media/svg/avatars/014-girl-7.svg')}></SVG>
                      </span>
                    </div>
                  </td>
                  <td className="pl-0">
                  ...
                  <td className="text-right">
                    <span className="text-muted font-weight-bold d-block font-size-sm">Paid</span>
                    <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$4,500,000</span>
                  </td>
                  <td className="text-right">
                ...
                <tr>
                  <td className="pl-0">
                    <div className="symbol symbol-50 symbol-light mr-2 mt-2">
                      <span className="symbol-label">
                        <SVG className="h-75 align-self-end" src={toAbsoluteUrl('/media/svg/avatars/043-boy-18.svg')}></SVG>
                      </span>
                    </div>
                  </td>
                  <td className="pl-0">
                  ...
                  <td className="text-right">
                    <span className="text-muted font-weight-bold d-block font-size-sm">Paid</span>
                    <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$35,600,000</span>
                  </td>
                  <td className="text-right">
