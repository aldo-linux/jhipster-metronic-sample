            ...
            <tbody>
              <tr>
                ...
                <td className="pl-0">
                  ...
                  <span className="text-muted font-weight-bold text-muted d-block">HTML, JS, ReactJS</span>
                </td>
                <td>
                ...
                <td>
                  <div className="d-flex flex-column w-100 mr-2">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="text-muted mr-2 font-size-sm font-weight-bold">65%</span>
              ...
              <tr>
                ...
                <td className="pr-0">
                  <div className="symbol symbol-50 symbol-light mt-1">
                    <span className="symbol-label">
                      <SVG src={toAbsoluteUrl('/media/svg/avatars/018-girl-9.svg')} className="h-75 align-self-end"></SVG>
                    </span>
                  </div>
                </td>
                <td className="pl-0">
                  ...
                  <span className="text-muted font-weight-bold text-muted d-block">C#, ASP.NET, MS SQL</span>
                </td>
                <td>
                ...
                <td>
                  <div className="d-flex flex-column w-100 mr-2">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="text-muted mr-2 font-size-sm font-weight-bold">83%</span>
                      <span className="text-muted font-size-sm font-weight-bold">Progress</span>
                    </div>
                    <div className="progress progress-xs w-100">
                      <div
              ...
              <tr>
                ...
                <td className="pr-0">
                  <div className="symbol symbol-50 symbol-lightv mt-1">
                    <span className="symbol-label">
                      <SVG src={toAbsoluteUrl('/media/svg/avatars/047-girl-25.svg')} className="h-75 align-self-end"></SVG>
                    </span>
                  </div>
                </td>
                <td className="pl-0">
                  ...
                  <span className="text-muted font-weight-bold text-muted d-block">PHP, Laravel, VueJS</span>
                </td>
                <td>
                ...
                <td>
                  <div className="d-flex flex-column w-100 mr-2">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="text-muted mr-2 font-size-sm font-weight-bold">47%</span>
                      <span className="text-muted font-size-sm font-weight-bold">Progress</span>
                    </div>
                    <div className="progress progress-xs w-100">
                      <div
              ...
              <tr>
                ...
                <td className="pl-0">
                  ...
                  <span className="text-muted font-weight-bold text-muted d-block">Python, PostgreSQL, ReactJS</span>
                </td>
                <td>
                ...
                <td>
                  <div className="d-flex flex-column w-100 mr-2">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="text-muted mr-2 font-size-sm font-weight-bold">71%</span>
                      <span className="text-muted font-size-sm font-weight-bold">Progress</span>
                    </div>
                    <div className="progress progress-xs w-100">
                      <div
