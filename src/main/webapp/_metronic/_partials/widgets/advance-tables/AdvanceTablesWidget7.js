    ...
    <div className={`card card-custom ${className}`}>
        ...
        <div className="card-toolbar">
          <Tab.Container defaultActiveKey={key}>
            <Nav as="ul" onSelect={_key => setKey(_key)} className="nav nav-pills nav-pills-sm nav-dark-75">
              ...
              <Nav.Item className="nav-item" as="li">
                <Nav.Link eventKey="Day" className={`nav-link py-2 px-4 ${key === 'Day' ? 'active' : ''}`}>
                  Day
                </Nav.Link>
              </Nav.Item>
            </Nav>
      ...
      <div className="card-body pt-2 pb-0 mt-n3">
        <div className={`tab-content mt-5`} id="myTabTables12">
          ...
          <div className={`tab-pane fade ${key === 'Month' ? 'show active' : ''}`}>
                ...
                <tbody>
                    ...
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light mr-1">
                        <span className="symbol-label">
                          <SVG src={toAbsoluteUrl('/media/svg/misc/006-plurk.svg')} className="h-50 align-self-center"></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
                  ...
                  <tr>
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light">
                        <span className="symbol-label">
                          <SVG className="h-50 align-self-center" src={toAbsoluteUrl('/media/svg/misc/015-telegram.svg')}></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
                  ...
                  <tr>
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light">
                        <span className="symbol-label">
                          <SVG className="h-50 align-self-center" src={toAbsoluteUrl('/media/svg/misc/003-puzzle.svg')}></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
                  ...
                  <tr>
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light">
                        <span className="symbol-label">
                          <SVG className="h-50 align-self-center" src={toAbsoluteUrl('/media/svg/misc/005-bebo.svg')}></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
                  ...
                  <tr>
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light">
                        <span className="symbol-label">
                          <SVG className="h-50 align-self-center" src={toAbsoluteUrl('/media/svg/misc/014-kickstarter.svg')}></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
          ...
          {/* begin::Tap pane WEEK */}
          <div className={`tab-pane fade ${key === 'Week' ? 'show active' : ''}`}>
            <div className="table-responsive">
              <table className="table table-borderless table-vertical-center">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td className="p-0 py-4">
                      <div className="symbol symbol-50 symbol-light mr-5">
                        <span className="symbol-label">
                          <SVG src={toAbsoluteUrl('/media/svg/misc/015-telegram.svg')} className="h-50 align-self-center"></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
                      ...
                      <span className="text-muted font-weight-bold d-block">
                        <span className="font-weight-bolder text-dark-75">FTP:</span> bprow@bnc.cc
                      </span>
                    </td>
                    <td className="text-right">
                      <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$4,600,000</span>
                  ...
                  <tr>
                    <td className="pl-0 py-4">
                      <div className="symbol symbol-50 symbol-light">
                        <span className="symbol-label">
                          <SVG className="h-50 align-self-center" src={toAbsoluteUrl('/media/svg/misc/006-plurk.svg')}></SVG>
                        </span>
                      </div>
                    </td>
                    <td className="pl-0">
          ...
          {/* begin::Tap pane DAY */}
          <div className={`tab-pane fade ${key === 'Day' ? 'show active' : ''}`}>
            <div className="table-responsive">
              <table className="table table-borderless table-vertical-center">
                <thead>
                  <tr>
