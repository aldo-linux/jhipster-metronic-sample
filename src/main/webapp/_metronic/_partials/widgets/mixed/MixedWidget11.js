      ...
      <div className="card-body d-flex flex-column">
        <div className="flex-grow-1 pb-5">
          ...
          <div className="d-flex align-items-center pr-2 mb-6">
            <span className="text-muted font-weight-bold font-size-lg flex-grow-1">2 Hours Ago</span>
        ...
        <div className="d-flex align-items-center">
          ...
          <a href="#" className="symbol symbol-45 symbol-light mr-3">
            <div className="symbol-label">
              <SVG src={toAbsoluteUrl('/media/svg/avatars/028-girl-16.svg')} className="h-75 align-self-end"></SVG>
            </div>
          </a>
          {/* end::Pic */}
          ...
          <a href="#" className="symbol symbol-45 symbol-light">
            <div className="symbol-label">
              <SVG src={toAbsoluteUrl('/media/svg/avatars/024-boy-9.svg')} className="h-75 align-self-end"></SVG>
            </div>
          </a>
          {/* end::Pic */}
          ...
          <a href="#" className="symbol symbol-45 symbol-light">
            <div className="symbol-label">
              <SVG src={toAbsoluteUrl('/media/svg/avatars/005-girl-2.svg')} className="h-75 align-self-end"></SVG>
            </div>
          </a>
          {/* end::Pic */}
        </div>
