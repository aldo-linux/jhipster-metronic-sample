...
export function TilesWidget11({ className, baseColor = 'primary', widgetHeight = '150px' }) {
  return (
    <>
      <div className={`card card-custom bg-${baseColor} ${className}`} style={{ height: widgetHeight }}>
        <div className="card-body">
          ...
          <div className={`text-inverse-${baseColor} font-weight-bolder font-size-h2 mt-3`}>790</div>
