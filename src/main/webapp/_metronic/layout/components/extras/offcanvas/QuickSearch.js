      ...
      <div id="kt_quick_search" className="offcanvas offcanvas-left p-10">
        ...
        <div className="offcanvas-header d-flex align-items-center justify-content-between mb-5">
          <h3 className="font-weight-bold m-0">
            Search
            <small className="text-muted font-size-sm ml-2">files, reports, members</small>
          </h3>
          <a href="#" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_search_close">
        ...
        <div className="offcanvas-content">
          {/* begin::Container */}
          <div className="quick-search quick-search-offcanvas quick-search-has-result" id="kt_quick_search_offcanvas">
            {/* begin::Form */}
            ...
            <div className="quick-search-wrapper pt-5">
              <div className="quick-search-result">
                ...
                {/* begin::Section */}
                <div className="font-size-sm text-primary font-weight-bolder text-uppercase mb-2">Documents</div>
                <div className="mb-10">
                  {/* begin::Item */}
                  ...
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">by Mary Broun</span>
                    </div>
                  </div>
                  {/* end::Item */}
                  ...
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">by Nick Stone</span>
                    </div>
                  </div>
                  {/* end::Item */}
                  ...
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">by Jhon Larson</span>
                    </div>
                  </div>
                  {/* end::Item */}
                </div>
                ...
                {/* begin::Section */}
                <div className="font-size-sm text-primary font-weight-bolder text-uppercase mb-2">Members</div>
                <div className="mb-10">
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                  ...
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">Marketing Manager</span>
                    </div>
                  </div>
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    <div className="symbol symbol-30 flex-shrink-0">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">Software Developer</span>
                    </div>
                  </div>
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    <div className="symbol symbol-30 flex-shrink-0">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">Project Coordinator</span>
                    </div>
                  </div>
                </div>
                {/* end::Section */}
                ...
                {/* begin::Section */}
                <div className="font-size-sm text-primary font-weight-bolder text-uppercase mb-2">Files</div>
                <div className="mb-10">
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    <div className="symbol symbol-30 flex-shrink-0">
                  ...
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    ...
                    <div className="d-flex flex-column ml-3 mt-2 mb-2">
                      ...
                      <span className="font-size-sm font-weight-bold text-muted">Total 234 items</span>
                    </div>
                  </div>
                  <div className="d-flex align-items-center flex-grow-1 mb-2">
                    <div className="symbol symbol-30 flex-shrink-0">
