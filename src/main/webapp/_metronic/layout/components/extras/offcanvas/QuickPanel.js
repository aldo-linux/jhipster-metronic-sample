    ...
    <div id="kt_quick_panel" className="offcanvas offcanvas-left pt-5 pb-10">
      <Tab.Container defaultActiveKey={selectedTab}>
        ...
        <div className="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
          ...
          >
            <Nav.Item as="li">
              <Nav.Link eventKey="AuditLogs" className={`nav-link ${selectedTab === 'AuditLogs' ? 'active' : ''}`}>
                Audit Logs
              </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item as="li">
              <Nav.Link eventKey="Settings" className={`nav-link ${selectedTab === 'Settings' ? 'active' : ''}`}>
                Settings
              </Nav.Link>
            </Nav.Item>
          </Nav>
            ...
            >
              <div className="mb-15">
                ...
                <div className="d-flex align-items-center flex-wrap mb-5">
                  <div className="symbol symbol-50 symbol-light mr-5">
                    <span className="symbol-label">
                      <img src={toAbsoluteUrl('/media/svg/misc/006-plurk.svg')} alt="" className="h-50 align-self-center" />
                    </span>
                  </div>
                  <div className="d-flex flex-column flex-grow-1 mr-2">
                    <a href="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">
                      Top Authors
                    </a>
                ...
                <div className="d-flex align-items-center flex-wrap mb-5">
                  <div className="symbol symbol-50 symbol-light mr-5">
                    <span className="symbol-label">
                      <img src={toAbsoluteUrl('/media/svg/misc/015-telegram.svg')} alt="" className="h-50 align-self-center" />
                    </span>
                  </div>
                  <div className="d-flex flex-column flex-grow-1 mr-2">
                    <a href="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">
                ...
                <div className="d-flex align-items-center flex-wrap mb-5">
                  <div className="symbol symbol-50 symbol-light mr-5">
                    <span className="symbol-label">
                      <img src={toAbsoluteUrl('/media/svg/misc/003-puzzle.svg')} alt="" className="h-50 align-self-center" />
                    </span>
                  </div>
                  <div className="d-flex flex-column flex-grow-1 mr-2">
                    <a href="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">
                ...
                <div className="d-flex align-items-center flex-wrap mb-5">
                  <div className="symbol symbol-50 symbol-light mr-5">
                    <span className="symbol-label">
                      <img src={toAbsoluteUrl('/media/svg/misc/005-bebo.svg')} alt="" className="h-50 align-self-center" />
                    </span>
                  </div>
                  <div className="d-flex flex-column flex-grow-1 mr-2">
                    <a href="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">
                ...
                <div className="d-flex align-items-center flex-wrap">
                  <div className="symbol symbol-50 symbol-light mr-5">
                    <span className="symbol-label">
                      <img src={toAbsoluteUrl('/media/svg/misc/014-kickstarter.svg')} alt="" className="h-50 align-self-center" />
                    </span>
                  </div>
                  <div className="d-flex flex-column flex-grow-1 mr-2">
                    <a href="#" className="font-weight-bolder text-dark-75 text-hover-primary font-size-lg mb-1">
                ...
                <div>
                  ...
                  <div className="form-group mb-0 row">
                    ...
                    <div className="col-4 text-right">
                      <span className="switch switch-success switch-sm">
                        <label>
                          <input type="checkbox" onChange={() => {}} checked name="" />
                          <span></span>
                        </label>
                      </span>
                    </div>
                  ...
                  <div className="form-group mb-0 row">
                    ...
                    <div className="col-4 text-right">
                      <span className="switch switch-success switch-sm">
                        <label>
                          <input type="checkbox" name="quick_panel_notifications_2" onChange={() => {}} />
                          <span></span>
                        </label>
                      </span>
                    </div>
