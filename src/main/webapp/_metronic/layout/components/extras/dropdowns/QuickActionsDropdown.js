      ...
      {layoutProps.offcanvas && (
        <OverlayTrigger placement="left" overlay={<Tooltip id="quick-actions-tooltip">Quick actions</Tooltip>}>
          <div className="topbar-item">
            <div className="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" id="kt_quick_actions_toggle">
        ...
        <Dropdown drop="down" alignRight>
          ...
          <Dropdown.Menu className="p-0 m-0 dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
            <form>
              ...
              >
                <h3 className="text-white font-weight-bold font-size-5">Quick Actions</h3>
                <span className="btn btn-success btn-sm btn-bold btn-font-md mt-2">23 tasks pending</span>
              </div>
              {/* end: Head */}
              ...
              <div className="row row-paddingless">
                ...
                <div className="col-6">
                  <a href="#" className="d-block py-10 px-5 text-center bg-hover-light border-bottom">
                    {' '}
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG src={toAbsoluteUrl('/media/svg/icons/Communication/Mail-attachment.svg')}></SVG>
                    </span>
                ...
                <div className="col-6">
                  <a href="#" className="d-block py-10 px-5 text-center bg-hover-light border-right">
                    <span className="svg-icon svg-icon-3x svg-icon-success">
                      <SVG src={toAbsoluteUrl('/media/svg/icons/Shopping/Box2.svg')}></SVG>
                    </span>
