      ...
      {!layoutProps.offcanvas && (
        ...
        >
          <Dropdown.Toggle as={DropdownTopbarItemToggler}>
            <OverlayTrigger placement="bottom" overlay={<Tooltip id="search-panel-tooltip">Quick search</Tooltip>}>
            ...
            >
              <form className="quick-search-form">
                <div className="input-group">
                  ...
                  <div className={`input-group-append ${loading ? 'spinner spinner-sm spinner-primary' : ''}")}`}>
                    <span className="input-group-text">
                      <i
                        style={{
