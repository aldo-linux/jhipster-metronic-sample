        ...
        <li className={`menu-item menu-item-submenu ${getMenuItemActive('/error', true)}`} aria-haspopup="true" data-menu-toggle="hover">
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              {/*begin::2 Level*/}
              <li className={`menu-item ${getMenuItemActive('/error/error-v3')}`} aria-haspopup="true">
              ...
              {/*begin::2 Level*/}
              <li className={`menu-item ${getMenuItemActive('/error/error-v4')}`} aria-haspopup="true">
              ...
              {/*begin::2 Level*/}
              <li className={`menu-item ${getMenuItemActive('/error/error-v5')}`} aria-haspopup="true">
              ...
              {/*begin::2 Level*/}
              <li className={`menu-item ${getMenuItemActive('/error/error-v6')}`} aria-haspopup="true">
