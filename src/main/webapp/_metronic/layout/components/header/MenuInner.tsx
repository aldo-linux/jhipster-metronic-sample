...
export function MenuInner() {
  ...
  return (
    <>
      ...
      <MenuInnerWithSub title="Crafted" to="/crafted" menuPlacement="bottom-start" menuTrigger="click">
        {/* PAGES */}
        <MenuInnerWithSub
          title="Pages"
          to="/crafted/pages"
        ...
        <MenuInnerWithSub
          title="Errors"
          to="/error"
          icon="/media/icons/duotone/Interface/Lock.svg"
          hasArrow={true}
      ...
      <MenuInnerWithSub isMega={true} title="Mega menu" to="/mega-menu" menuPlacement="bottom-start" menuTrigger="click">
        <MegaMenu />
      </MenuInnerWithSub>
    </>
  );
