      ...
      <div className={clsx(classes.headerContainer.join(' '), 'd-flex align-items-center')}>
        ...
        <div className="d-flex topbar align-items-center d-lg-none ms-n2 me-3" title="Show aside menu">
          <div className="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" id="kt_header_menu_mobile_toggle">
            <KTSVG path="/media/icons/duotone/Text/Menu.svg" className="svg-icon-2x" />
          </div>
        </div>

        <div className="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
          <Link to="/">
            <img alt="Logo" src={toAbsoluteUrl('/media/logos/logo-4.png')} className="logo-default h-25px" />
            <img alt="Logo" src={toAbsoluteUrl('/media/logos/logo-5.png')} className="logo-sticky h-25px" />
          </Link>
        </div>
