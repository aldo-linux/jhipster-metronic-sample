    ...
    <div className="d-flex align-items-stretch flex-shrink-0">
      <div className="topbar d-flex align-items-stretch flex-shrink-0">
        ...
        <div className={clsx('d-flex align-items-center', toolbarButtonMarginClass)}>
          ...
          >
            <KTSVG path="/media/icons/duotone/Layout/Layout-4-blocks.svg" className={toolbarButtonIconSizeClass} />
          </div>
          <QuickLinks />
          {/* end::Menu wrapper */}
        </div>
        ...
        <div className={clsx('d-flex align-items-center', toolbarButtonMarginClass)}>
          ...
          <div
            ...
            data-kt-menu-flip="bottom"
          >
            <KTSVG path="/media/icons/duotone/Code/Compiling.svg" className={toolbarButtonIconSizeClass} />
          </div>
        ...
        <div className={clsx('d-flex align-items-center', toolbarButtonMarginClass)} id="kt_header_user_menu_toggle">
          ...
          <div
            ...
            data-kt-menu-flip="bottom"
          >
            <img className="h-25px w-25px rounded" src={toAbsoluteUrl('/media/avatars/150-25.jpg')} alt="metronic" />
          </div>
          <HeaderUserMenu />
          {/* end::Toggle */}
        </div>
