...
const Demos: FC = () => (
  <div className="mb-0">
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 border-primary p-2 rounded">
        ...
        <div className="overlay-layer bg-dark bg-opacity-10">
          <a href={`${process.env.REACT_APP_PREVIEW_REACT_URL}/demo2`} className="btn btn-primary shadow">
            Preview
          </a>
        </div>
      </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo10.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo11.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo12.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo13.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo14.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
    ...
    <div className="mb-7">
      ...
      <div className="overlay overflow-hidden border border-4 p-2 rounded">
        <div className="overlay-wrapper">
          <img src={toAbsoluteUrl('/media/demos/demo15.png')} alt="demo" className="w-100 rounded" />
        </div>
        <div className="overlay-layer bg-dark bg-opacity-10">
          <div className="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
        </div>
