        ...
        <form ref={formRef} id="kt_inbox_compose_form" onSubmit={() => console.log('submit')}>
          ...
          <div className="d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-bottom">
            ...
            <div className="d-flex ms-2">
              {/*begin::Close*/}
              <div className="btn btn-icon btn-sm btn-light-primary ms-2" data-bs-dismiss="modal" onClick={handleClose}>
          ...
          <div className="d-block">
            ...
            <div className="d-flex align-items-center border-bottom inbox-to px-8 min-h-45px">
              ...
              <div className="d-flex align-items-center flex-grow-1">
                <input type="text" className="form-control border-0" name="compose_to" ref={composeToRef} />
              </div>
              <div className="ms-2">
                <span className="text-muted fw-bold cursor-pointer text-hover-primary me-2" data-inbox="cc-show">
                  Cc
                </span>
                <span className="text-muted fw-bold cursor-pointer text-hover-primary" data-inbox="bcc-show">
                  Bcc
                </span>
              </div>
            </div>
