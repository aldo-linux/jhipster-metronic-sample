    ...
    <div className="row g-0">
      <div className="col-6">
        <a href="#" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
          <KTSVG path="/media/icons/duotone/Shopping/Euro.svg" className="svg-icon-3x svg-icon-primary mb-2" />
      ...
      <div className="col-6">
        <a href="#" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
          <KTSVG path="/media/icons/duotone/Communication/Mail-attachment.svg" className="svg-icon-3x svg-icon-primary mb-2" />
      ...
      <div className="col-6">
        <a href="#" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
          <KTSVG path="/media/icons/duotone/Shopping/Box2.svg" className="svg-icon-3x svg-icon-primary mb-2" />
      ...
      <div className="col-6">
        <a href="#" className="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
          <KTSVG path="/media/icons/duotone/Communication/Group.svg" className="svg-icon-3x svg-icon-primary mb-2" />
