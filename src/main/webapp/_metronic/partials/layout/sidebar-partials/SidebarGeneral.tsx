  ...
  return (
    <>
      ...
      <ul className="sidebar-nav nav nav-tabs pt-15 pb-5 px-5" id="kt_sidebar_tabs" role="tablist">
        <li className="nav-item">
          <a
            ...
            id="kt_sidebar_tab_1"
          >
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/purple/aven.svg')} className="default" />
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/colored/aven.svg')} className="active" />
          </a>
        </li>
        ...
        <li className="nav-item">
          <a
            ...
            id="kt_sidebar_tab_2"
          >
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/purple/kanba.svg')} className="default" />
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/colored/kanba.svg')} className="active" />
          </a>
        </li>
        ...
        <li className="nav-item">
          <a
            ...
            id="kt_sidebar_tab_3"
          >
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/purple/fox-hub-2.svg')} className="default" />
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/colored/fox-hub-2.svg')} className="active" />
          </a>
        </li>
        ...
        <li className="nav-item">
          <a
            ...
            id="kt_sidebar_tab_4"
          >
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/purple/tower.svg')} className="default" />
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/colored/tower.svg')} className="active" />
          </a>
        </li>
        ...
        <li className="nav-item">
          <a
            ...
            id="kt_sidebar_tab_5"
          >
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/purple/treva.svg')} className="default" />
            <img alt="" src={toAbsoluteUrl('/media/svg/logo/colored/treva.svg')} className="active" />
          </a>
        </li>
      </ul>
      {/* end::Sidebar Nav */}
      ...
      <div id="kt_sidebar_content" className="py-10 px-5 px-lg-5">
        ...
        >
          <div className="tab-content">
            <div className={clsx('tab-pane', { active: activeTab === 0 })} id="kt_sidebar_tab_pane_1" role="tabpanel">
              {/* begin::Card */}
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    ...
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-1.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-2.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-3.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-5.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-6.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
            ...
            <div className={clsx('tab-pane', { active: activeTab === 1 })} id="kt_sidebar_tab_pane_2" role="tabpanel">
              {/* begin::Card */}
              <div className="card card-custom bg-transparent">
                {/* begin::Header */}
                <div className="card-header align-items-center border-0">
              ...
              <div className="card card-custom bg-transparent">
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img src={toAbsoluteUrl('/media/stock/600x400/img-7.jpg')} alt="" className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-8.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-9.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-19.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
            ...
            <div className={clsx('tab-pane', { active: activeTab === 2 })} id="kt_sidebar_tab_pane_3" role="tabpanel">
              {/* begin::Card */}
              <div className="card card-custom bg-transparent">
                {/* begin::Header */}
                <div className="card-header align-items-center border-0">
              ...
              <div className="card card-custom bg-transparent">
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img src={toAbsoluteUrl('/media/stock/600x400/img-17.jpg')} alt="" className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-10.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-4.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
            ...
            <div className={clsx('tab-pane', { active: activeTab === 3 })} id="kt_sidebar_tab_pane_4" role="tabpanel">
              {/* begin::Card */}
              <div className="card card-custom bg-transparent">
                {/* begin::Header */}
                <div className="card-header align-items-center border-0">
              ...
              <div className="card card-custom bg-transparent">
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-11.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img src={toAbsoluteUrl('/media/stock/600x400/img-9.jpg')} alt="" className="mw-100" />
                    </div>
                    {/* end::Symbol */}
            ...
            <div className={clsx('tab-pane', { active: activeTab === 4 })} id="kt_sidebar_tab_pane_5" role="tabpanel">
              {/* begin::Card */}
              <div className="card card-custom bg-transparent">
                {/* begin::Header */}
                <div className="card-header align-items-center border-0">
              ...
              <div className="card card-custom bg-transparent">
                ...
                <div className="card-body pt-0">
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-12.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-13.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-14.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center mb-7">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-15.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
                  ...
                  <div className="d-flex flex-wrap align-items-center">
                    {/* begin::Symbol */}
                    <div className="symbol symbol-40px symbol-2by3 me-4">
                      <img alt="" src={toAbsoluteUrl('/media/stock/600x400/img-16.jpg')} className="mw-100" />
                    </div>
                    {/* end::Symbol */}
      ...
      <div id="kt_sidebar_footer" className="py-2 px-5 pb-md-6 text-center">
        <a href="#" className="btn btn-color-white bg-white  bg-opacity-10 bg-hover-opacity-20 fw-bolder w-100">
