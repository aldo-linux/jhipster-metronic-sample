            ...
            <div className="pt-0">
                ...
                <div className="position-absolute mb-7">
                  <div className="symbol symbol-circle symbol-100px overflow-hidden d-flex flex-center z-index-1">
                    <span className="symbol-label bg-warning  align-items-end">
                      <img alt="Logo" src={toAbsoluteUrl('/media/svg/avatars/016-boy-7.svg')} className="mh-75px" />
                    </span>
                  </div>
                </div>
              ...
              <div className="pt-4">
                ...
                <div className="text-center pb-12">
                  ...
                  {/* end::Action */}
                  <span className="fw-bolder fs-6 text-primary px-4 py-2 rounded bg-white bg-opacity-10">Python Dev</span>
                  {/* begin::Action */}
                </div>
                {/* end::Title */}
        ...
        <div className="card card-custom bg-info">
          ...
          <div className="card-body">
            ...
            <div className="d-flex flex-wrap align-items-center mb-7">
              {/* begin::Symbol */}
              <div className="symbol symbol-40px symbol-2by3 me-4">
                <img src={toAbsoluteUrl('/media/stock/600x400/img-10.jpg')} alt="" className="mw-100" />
              </div>
              {/* end::Symbol */}
            ...
            <div className="d-flex flex-wrap align-items-center mb-7">
              {/* begin::Symbol */}
              <div className="symbol symbol-40px symbol-2by3 me-4">
                <img src={toAbsoluteUrl('/media/stock/600x400/img-1.jpg')} alt="" className="mw-100" />
              </div>
              {/* end::Symbol */}
            ...
            <div className="d-flex flex-wrap align-items-center">
              {/* begin::Symbol */}
              <div className="symbol symbol-40px symbol-2by3 me-4">
                <img src={toAbsoluteUrl('/media/stock/600x400/img-4.jpg')} alt="" className="mw-100" />
              </div>
              {/* end::Symbol */}
