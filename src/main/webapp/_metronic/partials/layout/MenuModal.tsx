      ...
      <div className="container">
        <div className="modal-header d-flex align-items-center justify-content-between border-0">
          <div className="d-flex align-items-center">
            {/* begin::Logo */}
            <Link to="/">
              <img alt="logo" className="h-30px" src={toAbsoluteUrl('/media/logos/logo-default.svg')} />
            </Link>
            {/* end::Logo */}
          </div>
          ...
          <div className="row py-10 g-5">
            ...
            <div className="col-lg-6">
              ...
              <div className="row g-5">
                ...
                <div className="col-sm-4">
                  <a href="#" className="card card-custom bg-light-warning hoverable min-h-125px shadow-none mb-5">
                    <div className="card-body d-flex flex-column flex-center text-center">
              ...
              <div className="row g-5">
                <div className="col-sm-8">
                  <a href="#" className="card card-custom bg-light-primary hoverable min-h-125px shadow-none mb-5">
                    <div className="card-body d-flex flex-column flex-center text-center">
                  ...
                  <div className="row g-5">
                    ...
                    <div className="col-sm-6">
                      <a href="#" className="card card-custom bg-light-success hoverable shadow-none min-h-125px mb-5">
                        <div className="card-body d-flex flex-column flex-center text-center">
                ...
                <div className="col-sm-4">
                  <a href="#" className="card card-custom card-stretch mb-5 bg-light-info hoverable shadow-none min-h-250px">
                    <div className="card-body d-flex flex-column p-0">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage: `url('${toAbsoluteUrl('/media/illustrations/terms-1.png')}')`,
                        }}
                      />
                    </div>
                  </a>
