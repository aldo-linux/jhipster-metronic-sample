            ...
            <div className="d-flex flex-column">
              <div className="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                <a
                  href="#"
                  className={
                    'btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 me-2 ' + (currentState === 'month' && 'active')
                  }
                  onClick={() => {
                ...
                <a
                  href="#"
                  className={
                    'btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 me-2 ' + (currentState === 'annual' && 'active')
                  }
                  onClick={() => {
                          ...
                          <div className="d-flex align-items-center me-2">
                            ...
                            <div className="flex-grow-1">
                              <h2 className="d-flex align-items-center fs-2 fw-bolder flex-wrap">
                                ...
                                {plan.label && <span className="badge badge-light-success ms-2 fs-7">{plan.label}</span>}
                              </h2>
                          ...
                          <div className="ms-5">
                            ...
                            {!plan.custom && (
                              <>
                                ...
                                <span className="fs-3x fw-bolder">{currentState === 'month' ? plan.priceMonth : plan.priceAnnual}</span>
                              ...
                              >
                                ...
                                <div className="pt-1">
                                  {plan.features!.map((feature, i) => {
                                    return (
                                      <div
                                        className={`d-flex align-items-center` + (i !== plan.features!.length - 1 && ' mb-7')}
                                        key={`${i}-${feature.title}`}
                                      >
                                        {feature.supported && (
                                          <>
                                            <span className="fw-bold fs-5 text-gray-700 flex-grow-1">{feature.title}</span>
                                        ...
                                        {!feature.supported && (
                                          <>
                                            <span className="fw-bold fs-5 text-gray-400 flex-grow-1">{feature.title}</span>
                                            <KTSVG path="/media/icons/duotone/Code/Error-circle.svg" className="svg-icon-1" />
                                          </>
                                        )}
                                      </div>
                                    );
