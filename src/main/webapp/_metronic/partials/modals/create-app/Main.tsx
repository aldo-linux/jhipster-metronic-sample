                      ...
                      <div className="current" data-kt-stepper-element="content">
                        <div className="w-100">
                          <div className="fv-row mb-10">
                            ...
                            <Field type="text" className="form-control form-control-lg form-control-solid" name="appName" placeholder="" />
                            ...
                            <div className="fv-row">
                              <label className="d-flex flex-stack mb-5 cursor-pointer">
                                <span className="d-flex align-items-center me-2">
                                  <span className="symbol symbol-50px me-6">
                                    <span className="symbol-label bg-light-primary">
                                      <KTSVG path="/media/icons/duotone/Home/Globe.svg" className="svg-icon-1 svg-icon-primary" />
                                    </span>
                                  </span>
                                ...
                                <span className="form-check form-check-custom form-check-solid">
                                  <Field className="form-check-input" type="radio" name="category" value="1" />
                                </span>
                              </label>
                              ...
                              <label className="d-flex flex-stack mb-5 cursor-pointer">
                                ...
                                <span className="form-check form-check-custom form-check-solid">
                                  <Field className="form-check-input" type="radio" name="category" value="2" />
                                </span>
                              </label>
                              ...
                              <label className="d-flex flex-stack cursor-pointer">
                                <span className="d-flex align-items-center me-2">
                                  <span className="symbol symbol-50px me-6">
                                    <span className="symbol-label bg-light-success">
                                      <KTSVG path="/media/icons/duotone/Devices/Watch1.svg" className="svg-icon-1 svg-icon-success" />
                                    </span>
                                  </span>
                                ...
                                <span className="form-check form-check-custom form-check-solid">
                                  <Field className="form-check-input" type="radio" name="category" value="3" />
                                </span>
                              </label>
                            </div>
                        ...
                        <div className="w-100">
                          <div className="fv-row">
                            ...
                            <label className="d-flex flex-stack cursor-pointer mb-5">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="framework" value="1" />
                              </span>
                            </label>
                            ...
                            <label className="d-flex flex-stack cursor-pointer mb-5">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="framework" value="2" />
                              </span>
                            </label>
                            ...
                            <label className="d-flex flex-stack cursor-pointer mb-5">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="framework" value="3" />
                              </span>
                            </label>
                            ...
                            <label className="d-flex flex-stack cursor-pointer">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="framework" value="4" />
                              </span>
                            </label>
                          </div>
                          <div className="fv-plugins-message-container invalid-feedback">
                      ...
                      <div data-kt-stepper-element="content">
                        <div className="w-100">
                          <div className="fv-row mb-10">
                            ...
                            <Field type="text" className="form-control form-control-lg form-control-solid" name="dbName" placeholder="" />
                            <div className="fv-plugins-message-container invalid-feedback">
                          ...
                          <div className="fv-row">
                            ...
                            <label className="d-flex flex-stack cursor-pointer mb-5">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="dbType" value="1" />
                              </span>
                            </label>
                            ...
                            <label className="d-flex flex-stack cursor-pointer mb-5">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="dbType" value="2" />
                              </span>
                            </label>
                            ...
                            <label className="d-flex flex-stack cursor-pointer">
                              ...
                              <span className="form-check form-check-custom form-check-solid">
                                <Field className="form-check-input" type="radio" name="dbType" value="3" />
                              </span>
                            </label>
                          </div>
                        ...
                        <div className="w-100">
                          ...
                          <div className="row mb-10">
                            ...
                            <div className="col-md-4 fv-row">
                              ...
                              <div className="position-relative">
                                <Field type="text" className="form-control form-control-solid" placeholder="CVV" name="cardCvv" />
                                <div className="fv-plugins-message-container invalid-feedback">
