...
const Card5: FC<Props> = ({ image, title, description, status, statusValue, statusDesc, progress, progressType }) => {
  return (
    <div className="card h-100">
      <div className="card-header flex-nowrap border-0 pt-9">
        ...
        <div className="card-toolbar m-0">
          ...
          >
            <KTSVG path="/media/icons/duotone/Layout/Layout-4-blocks-2.svg" className="svg-icon-3 svg-icon-primary" />
          </button>
      ...
      <div className="card-body d-flex flex-column px-9 pt-6 pb-8">
        ...
        <div className="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
          {status === 'up' && <KTSVG path="/media/icons/duotone/Navigation/Up-right.svg" className="svg-icon-3 me-1 svg-icon-success" />}

          {status === 'down' && <KTSVG path="/media/icons/duotone/Navigation/Down-left.svg" className="svg-icon-3 me-1 svg-icon-danger" />}
