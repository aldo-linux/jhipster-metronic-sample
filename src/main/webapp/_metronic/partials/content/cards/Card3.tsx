...
const Card3: FC<Props> = ({ color = '', avatar = '', online = false, name, job, avgEarnings, totalEarnings }) => {
  return (
    <div className="card">
      <div className="card-body d-flex flex-center flex-column p-9">
        <div className="mb-5">
          <div className="symbol symbol-75px symbol-circle">
            ...
            {online && <div className="symbol-badge bg-success start-100 top-100 border-4 h-15px w-15px ms-n3 mt-n3"></div>}
          </div>
        </div>
