        ...
        >
          ...
          <div className="carousel-inner pt-8">
            ...
            <div className="carousel-item">
              ...
              <div className="d-flex flex-column justify-content-between h-100">
                {/* begin::Title */}
                <h3 className="fs-3 text-gray-800 text-hover-primary fw-bolder cursor-pointer">Close 300 support tickets</h3>
                {/* end::Title */}

                {/* begin::Text */}
                <p className="text-gray-600 fw-bold pt-3 mb-0">Each Leaflet map instance has its own React context.</p>
                {/* end::Text */}
              </div>
              {/* end::Section */}
            </div>
