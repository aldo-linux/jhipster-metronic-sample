        ...
        <div className="pt-9">
          ...
          <div className="row">
            ...
            <div className="col mb-5">
              ...
              >
                <KTSVG className="svg-icon-2x ms-n1" path="/media/icons/duotone/General/Clipboard.svg" />{' '}
          ...
          <div className="row">
            <div className="col mb-5 me-n2">
              <button
                ...
                className="btn btn-outline btn-bg-light btn-color-gray-600 btn-active-light-primary border-dashed border-active px-6 py-7 text-start w-100 min-w-150px"
              >
                <KTSVG className="svg-icon-2x ms-n1" path="/media/icons/duotone/Files/Compiled-file.svg" />{' '}
            ...
            <div className="col mb-5">
              <button
                ...
                className="btn btn-outline btn-bg-light btn-color-gray-600 btn-active-light-primary border-dashed border-active px-6 py-7  text-start w-100 min-w-150px"
              >
                <KTSVG className="svg-icon-2x ms-n1" path="/media/icons/duotone/Files/File-cloud.svg" />{' '}
