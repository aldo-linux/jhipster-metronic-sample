    ...
    <div className={`card ${className}`}>
      ...
      <div className="card-header align-items-center border-0 mt-5">
        ...
        <div className="card-toolbar">
          ...
          >
            <KTSVG className="svg-icon-1" path="/media/icons/duotone/Layout/Layout-4-blocks-2.svg" />
          </button>
          <Dropdown2 />
          {/* end::Dropdown */}
        </div>
      ...
      <div className="card-body pt-0">
        <div className="d-flex flex-wrap flex-xxl-nowrap justify-content-center justify-content-md-start pt-4">
          ...
          <div className="me-sm-10 me-0">
            <ul className="nav flex-column nav-pills nav-pills-custom">
              <li className="nav-item mb-3">
                <a
                  onClick={() => setTab(1)}
                  className={`nav-link w-225px h-70px ${activeTab === '#tab1' ? 'active btn-active-light' : ''} fw-bolder me-2`}
                  id="tab1"
                >
                  <div className="nav-icon me-3">
                    <img alt="" src={toAbsoluteUrl('/media/svg/logo/gray/aven.svg')} className="default" />
              ...
              <li className="nav-item mb-3">
                <a
                  id="tab2"
                  className={`nav-link w-225px h-70px ${activeTab === '#tab2' ? 'active btn-active-light' : ''} fw-bolder me-2`}
                  onClick={() => setTab(2)}
                >
                  <div className="nav-icon me-3">
                    <img alt="" src={toAbsoluteUrl('/media/svg/logo/gray/tower.svg')} className="default" />
              ...
              <li className="nav-item mb-3">
                <a
                  id="tab3"
                  className={`nav-link w-225px h-70px ${activeTab === '#tab3' ? 'active btn-active-light' : ''} fw-bolder me-2`}
                  onClick={() => setTab(3)}
                >
                  <div className="nav-icon me-3">
                    <img alt="" src={toAbsoluteUrl('/media/svg/logo/gray/fox-hub-2.svg')} className="default" />
              ...
              <li className="nav-item mb-5">
                <a
                  id="tab4"
                  className={`nav-link w-225px h-70px ${activeTab === '#tab4' ? 'active btn-active-light' : ''} fw-bolder me-2`}
                  onClick={() => setTab(4)}
                >
                  <div className="nav-icon me-3">
                    <img alt="" src={toAbsoluteUrl('/media/svg/logo/gray/kanba.svg')} className="default" />
          ...
          >
            ...
            {/* begin::Tab Pane 4 */}
            <div className={`tab-pane fade ${activeTab === '#tab4' ? 'show active' : ''}`} id="tab4_content">
              {/* begin::Content */}
              <div className="d-flex justify-content-center mb-10">
                {/* begin::Item */}
                <div className="px-10">
