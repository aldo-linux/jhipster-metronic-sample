...
const StatsWidget9: React.FC<Props> = ({ className, innerPadding = '', children }) => {
  ...
  return (
    <div className={`card ${className}`}>
        ...
        >
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <ol className="p-0 m-0 carousel-indicators carousel-indicators-dots">
              <li data-bs-target="#kt_stats_widget_9_carousel" data-bs-slide-to="0" className="ms-1 active"></li>
              <li data-bs-target="#kt_stats_widget_9_carousel" data-bs-slide-to="1" className="ms-1"></li>
              <li data-bs-target="#kt_stats_widget_9_carousel" data-bs-slide-to="2" className="ms-1"></li>
            </ol>
      ...
      {/* begin::Footer */}
      <div className="card-footer border-0 d-flex align-items-center justify-content-between pt-0 pb-10">{children}</div>
      {/* end::Footer */}
    </div>
  );
};
