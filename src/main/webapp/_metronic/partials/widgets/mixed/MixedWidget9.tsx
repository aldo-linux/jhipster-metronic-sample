              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-info">
                    <KTSVG path="/media/icons/duotone/Design/Color-profile.svg" className="svg-icon-1 svg-icon-info" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-danger">
                    <KTSVG path="/media/icons/duotone/Home/Library.svg" className="svg-icon-1 svg-icon-danger" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-success">
                    <KTSVG path="/media/icons/duotone/Shopping/Cart3.svg" className="svg-icon-1 svg-icon-success" />
                  </div>
                </div>
                {/* end::Symbol */}
              ...
              <div className="d-flex align-items-center me-2">
                ...
                <div className="symbol symbol-50px me-3">
                  <div className="symbol-label bg-light-primary">
                    <KTSVG path="/media/icons/duotone/Shopping/Barcode-read.svg" className="svg-icon-1 svg-icon-primary" />
                  </div>
                </div>
                {/* end::Symbol */}
