        ...
        <div className="mt-5">
            ...
            <div className="d-flex align-items-center me-2">
              ...
              <div className="symbol symbol-50px me-3">
                <div className="symbol-label bg-light">
                  <img src={toAbsoluteUrl('/media/svg/brand-logos/plurk.svg')} alt="" className="h-50" />
                </div>
              </div>
              {/* end::Symbol */}
          ...
          <div className="d-flex flex-stack mb-5">
            ...
            <div className="d-flex align-items-center me-2">
              ...
              <div className="symbol symbol-50px me-3">
                <div className="symbol-label bg-light">
                  <img src={toAbsoluteUrl('/media/svg/brand-logos/figma-1.svg')} alt="" className="h-50" />
                </div>
              </div>
              {/* end::Symbol */}
          ...
          <div className="d-flex flex-stack">
            ...
            <div className="d-flex align-items-center me-2">
              ...
              <div className="symbol symbol-50px me-3">
                <div className="symbol-label bg-light">
                  <img src={toAbsoluteUrl('/media/svg/brand-logos/vimeo.svg')} alt="" className="h-50" />
                </div>
              </div>
              {/* end::Symbol */}
