  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className="card-body p-0">
        {/* begin::Chart */}
        <div ref={chartRef} className={`mixed-widget-2-chart card-rounded-bottom bg-${chartColor}`}></div>
        {/* end::Chart */}
        {/* begin::Stats */}
        <div className="card-p mt-n20 position-relative">
          ...
          <div className="row g-0">
            ...
            <div className="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
              <KTSVG path="/media/icons/duotone/Media/Equalizer.svg" className="svg-icon-3x svg-icon-warning d-block my-2" />
            ...
            <div className="col bg-light-primary px-6 py-8 rounded-2 mb-7">
              <KTSVG path="/media/icons/duotone/Communication/Add-user.svg" className="svg-icon-3x svg-icon-primary d-block my-2" />
          ...
          <div className="row g-0">
            ...
            <div className="col bg-light-danger px-6 py-8 rounded-2 me-7">
              <KTSVG path="/media/icons/duotone/Design/Layers.svg" className="svg-icon-3x svg-icon-danger d-block my-2" />
            ...
            <div className="col bg-light-success px-6 py-8 rounded-2">
              <KTSVG path="/media/icons/duotone/Communication/Urgent-mail.svg" className="svg-icon-3x svg-icon-success d-block my-2" />
