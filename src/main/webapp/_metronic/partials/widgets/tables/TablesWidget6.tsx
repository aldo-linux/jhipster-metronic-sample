                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-end">
                      <a href="#" className="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
                        <KTSVG path="/media/icons/duotone/Navigation/Arrow-right.svg" className="svg-icon-2" />
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label">
                          <img src={toAbsoluteUrl('/media/svg/avatars/018-girl-9.svg')} className="h-75 align-self-end" alt="" />
                        </span>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label">
                          <img src={toAbsoluteUrl('/media/svg/avatars/043-boy-18.svg')} className="h-75 align-self-end" alt="" />
                        </span>
                      </div>
                    </td>
                    <td>
