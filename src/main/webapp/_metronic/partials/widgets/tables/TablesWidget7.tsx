                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-success">
                          <KTSVG path="/media/icons/duotone/Media/Playlist1.svg" className="svg-icon-2x svg-icon-success" />
                        </span>
                      </div>
                    </td>
                    <td>
                      ...
                      <span className="text-muted fw-bold d-block fs-7">Voice and video recorder</span>
                    </td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-danger">
                          <KTSVG path="/media/icons/duotone/Layout/Layout-4-blocks-2.svg" className="svg-icon-2x svg-icon-danger" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-primary">
                          <KTSVG path="/media/icons/duotone/Home/Globe.svg" className="svg-icon-2x svg-icon-primary" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-warning">
                          <KTSVG path="/media/icons/duotone/Home/Library.svg" className="svg-icon-2x svg-icon-warning" />
                        </span>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-info">
                          <KTSVG path="/media/icons/duotone/Design/Color-profile.svg" className="svg-icon-2x svg-icon-info" />
                        </span>
                      </div>
                    </td>
                    <td>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-info">
                          <KTSVG path="/media/icons/duotone/Shopping/Box2.svg" className="svg-icon-2x svg-icon-info" />
                        </span>
                      </div>
                    </td>
                    <td>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div className="symbol symbol-50px me-2">
                        <span className="symbol-label bg-light-success">
                          <KTSVG path="/media/icons/duotone/Shopping/Cart3.svg" className="svg-icon-2x svg-icon-success" />
                        </span>
                      </div>
                    </td>
                    <td>
