            ...
            <tbody>
              <tr>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label bg-light">
                        <img src={toAbsoluteUrl('/media/svg/avatars/001-boy.svg')} className="h-75 align-self-end" alt="" />
                      </span>
                    </div>
                ...
                <td>
                  ...
                  <span className="text-muted fw-bold text-muted d-block fs-7 mt-1">Best Rated</span>
                </td>
                <td className="text-end">
                  <a href="#" className="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2">
                    View
                  </a>
                  <a href="#" className="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4">
                    Edit
                  </a>
                </td>
              </tr>
              <tr>
                <td>
                  <div className="d-flex align-items-center">
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label bg-light">
                        <img src={toAbsoluteUrl('/media/svg/avatars/047-girl-25.svg')} className="h-75 align-self-end" alt="" />
                      </span>
                    </div>
                    <div className="d-flex justify-content-start flex-column">
                      <a href="#" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">
                ...
                <td>
                  ...
                  <span className="text-muted fw-bold text-muted d-block fs-7 mt-1">Above Avarage</span>
                </td>
                <td className="text-end">
                  <a href="#" className="btn btn-bg-light btn-color-muted btn-active-color-primary btn-sm px-4 me-2">
                    View
              ...
              <tr>
                <td>
                  <div className="d-flex align-items-center">
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label bg-light">
                        <img src={toAbsoluteUrl('/media/svg/avatars/006-girl-3.svg')} className="h-75 align-self-end" alt="" />
                      </span>
                    </div>
                    <div className="d-flex justify-content-start flex-column">
                      <a href="#" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">
              ...
              <tr>
                <td>
                  <div className="d-flex align-items-center">
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label bg-light">
                        <img src={toAbsoluteUrl('/media/svg/avatars/014-girl-7.svg')} className="h-75 align-self-end" alt="" />
                      </span>
                    </div>
                    <div className="d-flex justify-content-start flex-column">
                      <a href="#" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">
              ...
              <tr>
                <td>
                  <div className="d-flex align-items-center">
                    <div className="symbol symbol-50px me-5">
                      <span className="symbol-label bg-light">
                        <img src={toAbsoluteUrl('/media/svg/avatars/020-girl-11.svg')} className="h-75 align-self-end" alt="" />
                      </span>
                    </div>
                    <div className="d-flex justify-content-start flex-column">
                      <a href="#" className="text-dark fw-bolder text-hover-primary mb-1 fs-6">
