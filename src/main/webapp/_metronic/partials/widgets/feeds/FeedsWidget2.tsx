      ...
      <div className="card-body pb-0">
        ...
        <div className="mb-5">
          ...
          <p className="text-gray-800 fw-normal mb-5">
            Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors about driving and keep you focused on the
          ...
          <div className="d-flex align-items-center mb-5">
            <a href="#" className="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
              <KTSVG path="/media/icons/duotone/Communication/Group-chat.svg" className="svg-icon-2" />
              120
            </a>
        ...
        <form className="position-relative mb-6">
          <textarea className="form-control border-0 p-0 pe-10 resize-none min-h-25px" rows={1} placeholder="Reply.."></textarea>
