...
const EngageWidget3: React.FC<Props> = ({ className, imagePath = '', innerPadding = '', color = 'primary' }) => {
  return (
    <div className={`card card-custom ${className}`}>
      {/* begin::Card Body */}
      <div className={`card-body d-flex p-12 flex-column flex-md-row flex-lg-column flex-xxl-row bg-${color}`}>
        {/*begin::Image*/}
        <div
        ...
        <div className="card shadow-none w-auto w-md-300px w-lg-auto w-xxl-300px ml-auto">
          ...
          <div className="card-body bg-light px-12 py-10">
            ...
            <div className="fs-7 mb-8">
              Outlines keep you honest. They stop you from indulging in poorly ought out metaphorsy about driving and keep you focused one
              the overall structure of your post
            </div>
            {/*begin::Info*/}
