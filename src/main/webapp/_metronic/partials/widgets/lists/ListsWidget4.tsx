    ...
    <div className="card card-xl-stretch mb-xl-8">
      ...
      <div className="card-body pt-5">
        ...
        <div className="d-flex align-items-sm-center mb-7">
          ...
          <div className="symbol symbol-50px me-5">
            <span className="symbol-label">
              <img src={toAbsoluteUrl('/media/svg/brand-logos/telegram.svg')} className="h-50 align-self-center" alt="" />
            </span>
          </div>
          {/* end::Symbol */}
          {/* begin::Section */}
        ...
        <div className="d-flex align-items-sm-center mb-7">
          ...
          <div className="symbol symbol-50px me-5">
            <span className="symbol-label">
              <img src={toAbsoluteUrl('/media/svg/brand-logos/vimeo.svg')} className="h-50 align-self-center" alt="" />
            </span>
          </div>
          {/* end::Symbol */}
          {/* begin::Section */}
        ...
        <div className="d-flex align-items-sm-center mb-7">
          ...
          <div className="symbol symbol-50px me-5">
            <span className="symbol-label">
              <img src={toAbsoluteUrl('/media/svg/brand-logos/bebo.svg')} className="h-50 align-self-center" alt="" />
            </span>
          </div>
          {/* end::Symbol */}
          {/* begin::Section */}
        ...
        {items > 4 && (
          <div className="d-flex align-items-sm-center mb-7">
            ...
            <div className="symbol symbol-50px me-5">
              <span className="symbol-label">
                <img src={toAbsoluteUrl('/media/svg/brand-logos/kickstarter.svg')} className="h-50 align-self-center" alt="" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Section */}
        ...
        {items > 5 && (
          <div className="d-flex align-items-sm-center">
            ...
            <div className="symbol symbol-50px me-5">
              <span className="symbol-label">
                <img src={toAbsoluteUrl('/media/svg/brand-logos/fox-hub.svg')} className="h-50 align-self-center" alt="" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Section */}
