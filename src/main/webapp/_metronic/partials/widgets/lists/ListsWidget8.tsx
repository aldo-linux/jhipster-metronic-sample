      ...
      <div className="card-body pt-3">
        ...
        <div className="d-flex align-items-sm-center mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-17.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Content */}
          <div className="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
            ...
            <div className="d-flex align-items-center">
              ...
              <a href="#" className="btn btn-icon btn-light btn-sm border-0">
                <KTSVG path="/media/icons/duotone/Navigation/Arrow-right.svg" className="svg-icon-2 svg-icon-primary" />
              </a>
            </div>
            {/* end::Section */}
          </div>
        ...
        <div className="d-flex align-items-sm-center mb-7">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-10.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Content */}
          <div className="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
        ...
        <div className="d-flex align-items-sm-center mb-7">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-1.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Content */}
          <div className="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
        ...
        <div className="d-flex align-items-sm-center">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-9.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Content */}
          <div className="d-flex flex-row-fluid align-items-center flex-wrap my-lg-0 me-2">
            ...
            <div className="flex-grow-1 my-lg-0 my-2 me-2">
              ...
              <span className="text-muted fw-bold d-block pt-1">Food trends &amp; inspirations</span>
            </div>
            {/* end::Title */}
            {/* begin::Section */}
            <div className="d-flex align-items-center">
