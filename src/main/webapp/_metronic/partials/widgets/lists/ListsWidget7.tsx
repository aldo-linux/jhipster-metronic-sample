      ...
      <div className="card-body pt-3">
        ...
        <div className="d-flex align-items-sm-center mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-20.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Title */}
        ...
        <div className="d-flex align-items-sm-center mb-7">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-19.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Title */}
          <div className="d-flex flex-row-fluid flex-wrap align-items-center">
        ...
        <div className="d-flex align-items-sm-center mb-7">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-25.jpg')})` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Title */}
          <div className="d-flex flex-row-fluid flex-wrap align-items-center">
        ...
        <div className="d-flex align-items-sm-center">
          {/* begin::Symbol */}
          <div className="symbol symbol-60px symbol-2by3 me-4">
            <div className="symbol-label" style={{ backgroundImage: `url(${toAbsoluteUrl('/media/stock/600x400/img-24.jpg')}` }}></div>
          </div>
          {/* end::Symbol */}
          {/* begin::Title */}
          <div className="d-flex flex-row-fluid flex-wrap align-items-center">
