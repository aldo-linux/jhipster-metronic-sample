...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ridm.services.connector.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ridm.services.connector.repository.UserRepository.USERS_BY_EMAIL_CACHE);
